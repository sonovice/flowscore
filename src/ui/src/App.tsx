...
function App() {
  ...
  onMount(() => {
    ...
    useScoreProvider(svgStrings, setSvgStrings, containerRef, virtualScroller);
  ...
  return (
    <>
      ...
      <button class="opacity-50 hover:opacity-100 fixed bottom-4 right-4 h-12 w-12 flex items-center justify-center bg-blue-500 text-white rounded-full shadow-lg"
